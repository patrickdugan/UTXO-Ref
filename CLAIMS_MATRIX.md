...
| Reserve is *encumbered* (cannot be spent elsewhere before challenge resolves) | — | **NOT_IMPLEMENTED** | Reserve is ordinary spendable wallet UTXOs; no covenant/timelock/freeze mechanism exists. See SECURITY_BLOCKERS #4 |
