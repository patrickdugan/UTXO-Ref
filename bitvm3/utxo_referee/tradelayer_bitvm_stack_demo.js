...
function markdownSummary(bundle, verification) {
  ...
  return [
    ...
    `- Halal capital token plan: ${bundle.halalCapitalTokenPlan.planId}`,
    '',
    '## Capital Receipts',
    '',
    `- Principal receipt supply: ${dashboard.capital.principalUnits}`,
    `- Service revenue accrual: ${dashboard.capital.serviceRevenueUnits}`,
    `- Property templates: ${dashboard.capital.tokenSpecCount}`,
    '',
    '## Dashboard Contract',
    '',
